    ...
    def __call__(
        ...
        with ctimed("Preprocessing"):
            ...
            if latent_size_override:
                latent_size_sq = latent_size_override
            else:
                latent_size_sq = 1024 * 1024
            calculated_width, calculated_height = calculate_dimensions(latent_size_sq, image_size[0] / image_size[1])
